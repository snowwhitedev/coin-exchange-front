          ...
          >
            ...
            <a-form-model-item prop="agreeTerms">
              <a-checkbox v-model="signUpEmail.agreeTerms">
                {{ $t('login_text_term_of_use') }}
                <span class="Roboto-Medium">{{
                  $t('login_text_cointral_terms')
                }}</span>
              </a-checkbox>
            </a-form-model-item>
            <a-form-model-item>
          ...
          >
            ...
            <a-form-model-item prop="agreeTerms">
              <a-checkbox v-model="signUpMobile.agreeTerms">
                {{ $t('login_text_term_of_use_mobile') }}
                <span class="Roboto-Medium">{{
                  $t('login_text_cointral_terms')
                }}</span>
              </a-checkbox>
...
export default {
  ...
  data() {
    const termsValidator = (rule, value, callback) => {
      if (value || this.activeKey === 'Mobile') {
        ...
        callback(new Error('Please agree our terms and privacy'))
      }
    }
    ...
    return {
      ...
      emailSignUpRules: {
        ...
        agreeTerms: [{ validator: termsValidator, tigger: 'change' }],
      },
      mobileSignUpRules: {
        Password: [
          {
        ...
        agreeTerms: [{ validator: termsValidatorMobile, tigger: 'change' }],
      },
    }
  },
  mounted() {
  ...
  methods: {
    emitEmailSignUp() {
      this.$refs.signUpEmailFormRef.validate((valid) => {
        if (valid) {
          this.$emit('signUp', this.signUpEmail)
        }
      })
    },
    emitMobileSignUp() {
      ...
      this.$refs.signUpMobileFormRef.validate((valid) => {
