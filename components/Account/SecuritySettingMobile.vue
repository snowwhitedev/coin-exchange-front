    ...
    <div class="twofa">
      ...
      <div class="twofa-list">
        ...
        <a-button
          ...
          block
          class="Roboto-Medium btn-primary-outline v-button"
          @click="$router.push(localeRoute('/account/enableSms'))"
          >{{ $t('text_open') }}</a-button
        >
        <a-button
          v-else
      ...
      <div class="twofa-list">
        ...
        <a-button
          ...
          block
          class="Roboto-Medium btn-primary-outline v-button"
          @click="$router.push(localeRoute('/account/enable2fa'))"
          >{{ $t('text_open') }}</a-button
        >
        <a-button
          v-else
...
export default {
  ...
  computed: {
    totalVerifications() {
      let vrfs = 0
      vrfs +=
        this.UserInfo.EnableSMSVerify || this.UserInfo.Enable2FAVerify ? 1 : 0
