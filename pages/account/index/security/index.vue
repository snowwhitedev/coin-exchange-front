          ...
          <div class="security-links">
            ...
            >
              <a-list-item class="security-settings-list-item Roboto-Medium">
                <a-list-item-meta title="2FA | İki Faktörlü Doğrulama">
                  <img
              ...
              <a-list-item class="security-settings-list-item Roboto-Medium">
                <a-list-item-meta title="Kimlik Doğrulaması">
                  <img
              ...
              <a-list-item class="security-settings-list-item Roboto-Medium">
                <a-list-item-meta title="Anti-Phishing Kodu">
                  <img
        ...
        <a-card class="security-setting-card border-none mb-common">
          <a-list class="auth-type-list" :loading="false">
            ...
            <a-list-item class="Roboto-Medium auth-type-list-item">
              ...
              <div v-if="UserInfo.Enable2FAVerify">
                <nuxt-link :to="localePath('/account/enable2fa')">
                  <a-button
                    slot="actions"
                    type="primary"
                    block
        ...
        >
          <a-list :loading="false">
            <a-list-item class="Roboto-Medium">
              <a-list-item-meta>
                <a-icon slot="avatar" type="close-circle" />
                <h3 slot="title" class="list-title Roboto-Medium"></h3>
              </a-list-item-meta>
              <div
                v-if="
                  UserInfo.CorporateStatus === 'NoCorporate' &&
                  UserInfo.KYCVerified === false
                "
              >
                <a :disbaled="true" class="Roboto-Medium">{{
                  $t('text_enterprise_account_reference')
                }}</a>
              </div>
              <div
                v-if="
                  UserInfo.CorporateStatus === 'NoCorporate' &&
                  UserInfo.KYCVerified === true
                "
              >
                <a
                  class="Roboto-Medium"
                  @click.prevent="
                    $router.push(localeRoute('/account/corporate'))
                  "
                  >{{ $t('text_enterprise_account_reference') }}</a
                >
              </div>
              <div
                v-else-if="UserInfo.CorporateStatus === 'CorporateInProgress'"
              >
                <a :disabled="true" class="Roboto-Medium">{{
                  $t('text_inprogress')
                }}</a>
              </div>
              <div v-else-if="UserInfo.CorporateStatus === 'CorporateRevision'">
                <a
                  @click.prevent="
                    $router.push(localeRoute('/account/corporate'))
                  "
              ...
              <div v-else-if="UserInfo.CorporateStatus === 'CorporateDone'">
                <a :disabled="true" class="Roboto-Medium"
                  >Kurumsal hesabınız onaylandı</a
                >
              </div>
            </a-list-item>
          </a-list>
