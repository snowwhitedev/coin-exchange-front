      ...
      >
        ...
        >
          <a-col offset="1" :span="24">
            <a-col :span="4" align="left">Hesap Adı</a-col>
        ...
        <a-row>
          ...
          >
            ...
            <a-col :span="24">
              <li>{{ $t('bank_accounts_tips_item_3') }}</li>
            </a-col>
            <a-col :span="24">
              <li>{{ $t('bank_accounts_tips_item_4') }}</li>
            </a-col>
            <a-col :span="24">
              <li>{{ $t('bank_accounts_tips_item_5') }}</li>
            </a-col>
            <a-col :span="24">
              <li>{{ $t('bank_accounts_tips_item_6') }}</li>
            </a-col>
          </a-col>
        </a-row>
      </a-col>
  ...
  methods: {
    ...
    async createCustomerBankAccount() {
      try {
        if (this.data.length === 3) {
          ...
          this.message = 'En fazla 3 banka hesabı eklenebilir.'
          this.isError = true
        ...
        this.typeAlert = 'error'
        this.message = 'Session Geçersidir'
        this.isError = true
        setTimeout(() => (this.isError = false), 2000)
      }
    },
    ...
    async getCustomerBankAccountList() {
      try {
        ...
        console.log(
          `Error occurred, when getting fiat wallet withdraw history: ${e}`
        )
        return false
      }
    },
