<template>
  <div :class="!isMobile ? 'account-page' : null">
    <div class="account-page-navigation hide-mobile-1000">
      <SideBar @menuClick="changeCurrentComponent" />
    </div>
    <div class="account-page-content hide-mobile-1000">
    ...
    <div v-if="isMobile">
      ...
      >
        <a-tab-pane key="/account/dashboard">
          <span
            slot="tab"
  ...
  watch: {
    $route: {
      handler: function (val) {
        this.activeAccountMenu = val.path
      },
      immediate: true,
    },
  },
