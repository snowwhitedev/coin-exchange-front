      ...
      >
        ...
        <a-col class="tip" :span="24">
          ...
          <a-col :span="22">
            ...
            <a-col style="margin-top: 5px" :span="24">
              <li>{{ $t('fiat_wallet_text_condition4') }}</li>
            </a-col>
            <a-col style="margin-top: 5px" :span="24">
              <li>{{ $t('fiat_wallet_text_condition5') }}</li>
            </a-col>
            <a-col style="margin-top: 5px" :span="24">
              <li>
...
export default {
  ...
  methods: {
    ...
    checkKycRequired() {
      console.log(this.USER_FIAT_WALLET_DEPOSIT['KycRequired'])
      if (this.USER_FIAT_WALLET_DEPOSIT['KycRequired'] === true) {
        console.log('KYC need to be verified!')
        // TODO: Route kyc page
